...
const ITEMS = [
  {
    q: 'А что за баня? Сразу после банкета?',
    a: 'Да! После банкета, с 23:00, на территории — afterparty: бассейн, баня и отдых до утра. Можно выдохнуть, поплавать и попариться — вечеринка продолжается.',
  },
  {
    q: 'Будет ли трансфер?',
  ...
  {
    q: 'Что взять с собой?',
    a: 'После банкета — afterparty с бассейном и баней. Захватите купальник или плавки (и при желании сменную одежду) — вечеринка продолжается!',
  },
  {
