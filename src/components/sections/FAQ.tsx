...
const ITEMS = [
  {
    ...
    a: 'Да! После банкета, с 23:00, на территории начинается afterparty: бассейн, баня и отдых до утра. Можно выдохнуть, поплавать и попариться. Вечеринка продолжается.',
  },
  {
    q: 'Будет ли трансфер?',
  ...
  },
  {
    ...
    a: 'Будем много танцевать, а часть территории покрыта газоном. К туфлям захватите что-нибудь удобное.',
  },
  {
