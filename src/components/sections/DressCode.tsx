...
const MESSAGES = [
  ...
  'Этот цвет теперь новая классика.',
  ...
  return (
    <section className="bg-olive py-16">
      ...
      <p className="text-xl md:text-2xl text-bg-warm/85 leading-relaxed mb-10">
        Строгого дресс-кода по цвету нет. Подойдёт любой оттенок, кроме
        красного и белого. Но формат вечера официальный, поэтому выбирайте
        нарядный, торжественный образ.
      </p>
